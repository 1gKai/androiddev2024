...
// returns an instance of Fragment corresponding to the specified page
        switch (page) {
            case 0: return WeatherAndForecastFragment.newInstance("Hanoi", R.drawable.thunderstorms);
            case 1: return WeatherAndForecastFragment.newInstance("Paris", R.drawable.rainy );
            case 2: return WeatherAndForecastFragment.newInstance("Melbourne", R.drawable.sunny);
        }
